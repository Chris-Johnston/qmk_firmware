...
// Momentarily activate the function layer when this key is held down
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    FUNCT  , _______, _______, _______, _______, _______, _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
...
/* Adjust (Lower + Raise, or the FUNCT key)
 * ,-----------------------------------------------------------------------------------.
 * |      | Reset| DBG  |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
uint32_t layer_state_set_user(uint32_t state) {
  ...
  // unint32_t mask12 = (1UL << layer1) | (1UL << layer2);
}
